...
class UnderImplementationOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $admins = Order::query()->with(['province', 'trader', 'delivery'])->where('status', 'under_implementation')->orderBy('updated_at', 'desc');
...
//                    return $status;
        ...
        return view('Admin.CRUDS.Orders.underImplementationOrders.index');
    }

...
class CollectionOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $admins = Order::query()->with(['province', 'trader', 'delivery'])->where('status', 'collection')->orderBy('updated_at', 'desc');
...
//                    return $status;
        ...
        return view('Trader.Orders.collectionOrders.index', compact('total_value'));
    }

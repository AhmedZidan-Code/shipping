...
@section('content')
            ...
            <div class="col-md-4">
                ...
                <select id="delivery_id" class="form-control showBonds" name="delivery_id">
                    ...
                    @foreach ($deliveries as $row)
                        <option value="{{ $row->id }}" {{ $row->id == request('delivery_id') ? 'selected' : '' }}>
                            {{ $row->name }}</option>
                    @endforeach
                </select>
            </div>
    ...
    <table id="table" class="table table-bordered dt-responsive nowrap table-striped align-middle"
        ...
        <tfoot style="background-color: darkgray;">
            <tr>
                <td> عدد التنفيذات:
                    <input style="outline: none; border: none; box-shadow: none;" type="text" name="orders_count"
                        id="orders_count" readonly>
                </td>
                <td colspan="2"> شحن المندوب:
                    <input style="outline: none; border: none; box-shadow: none;" type="text" name="mandoub_commission"
                        id="mandoub_commission" readonly>
                </td>
                <td colspan="2"> مصاريف المندوب :
                    <input style="outline: none; border: none; box-shadow: none;" type="text" name="fees" id="fees"
                        readonly>
                </td>
                ...
                <td colspan="1"> المرتب الصافي :
                    <input style="outline: none; border: none; box-shadow: none;" type="text" name="total" id="total"
                        readonly>
                </td>
                <td></td>
            </tr>
            <tr>
                ...
                <td colspan="2"> المصاريف الادارية :
                    <input style="outline: none; border: none; box-shadow: none;" type="text" name="expenses"
                        id="expenses" readonly>
                </td>
                <td colspan="2"> مصاريف البنزين :
                    <input style="outline: none; border: none; box-shadow: none;" type="text" name="solar" id="solar"
                        readonly>
                </td>
                <td colspan="3">أربـــاح الشركة :
                    <input style="outline: none; border: none; box-shadow: none;" type="text" name="profit" id="profit"
                        readonly>
                </td>

    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled " id="side-menu">
                ...
                @canany(['عرض الطلبات', 'عرض الطلبات المحولة للمناديب', 'عرض طلبات قيد التحصيل', 
                         'عرض الطلبات المؤجلة', 'عرض الشحن عالراسل', 'عرض طلبات تحت التنفيذ'])
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="fa fa-shipping-fast"></i>
                        <span> الطلبات </span>

...
@section('content')
    ...
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input disabled type="text" id="customer_phone" name="customer_phone" class="form-control" value="{{$order->customer_phone}}">
        </div>
...
{{--                </div>--}}
      ...
      <table class="table table-bordered dt-responsive nowrap table-striped align-middle dataTable no-footer dtr-inline collapsed" id="table">
      <thead>
       <tr>
       <th> نوع التغير </th>
       <th> من </th>
      ...
      @if($order->status == 'converted_to_delivery')

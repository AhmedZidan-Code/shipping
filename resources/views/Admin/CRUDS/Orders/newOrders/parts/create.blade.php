                        ...
                        <div class="card-body">
                            <div class="row  g-4">
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" id="customer_name-1" name="customer_name[]" class="form-control formv1 customer_name"
                                           value="">
                                </div>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    ...
                                    <select id='province_id' onchange="get_delivery_value(1)" class="province_id1" name="province_id[]"  style='width: 200px;'>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" id="customer_address-1" name="customer_address[]" class="form-control formv1"
                                           value="">
                                </div>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" id="customer_phone-1" name="customer_phone[]" class="form-control formv1"
                                           value="">
                                </div>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    ...
                                    <select id='trader_id' name="trader_id[]" onchange="get_delivery_value(1)" class="formv1 trader_id1" style='width: 200px;'>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    ...
                                    <!--end::Label-->
                                    <input type="number" min="0" onkeyup="get_order_value(1)" id="total" name="total[]"
                                           class="form-control formv1 total1" value="">
                                </div>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    ...
                                    <!--end::Label-->
                                    <input type="number" id="shipment_value-1" name="shipment_value[]"
       ...
       var trader_id=$('.trader_id'+valu).val();
        ...
        if(province_id && trader_id)
        {
             $.ajax({
                        ...
                        type: 'POST',
                        data: {province_id: province_id ,trader_id : trader_id},
                        beforeSend: function () {

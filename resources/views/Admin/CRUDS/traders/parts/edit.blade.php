...
<form id="form" enctype="multipart/form-data" method="POST" action="{{ route('traders.update', $row->id) }}">
    ...
    <div class="row g-4">
        ...
        <div class="form-group">
            ...
            <input type="file" class="dropify" name="logo" data-default-file="{{ get_file($row->logo) }}"
                accept="image/*" />
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="competent_name" type="text" class="form-control form-control-solid" placeholder=""
                name="competent_name" value="{{ $row->competent_name }}" />
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="competent_phone" type="number" class="form-control form-control-solid" placeholder=""
                name="competent_phone" value="{{ $row->competent_phone }}" />
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            <!--begin::Label-->
            <label for="debt" class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                <span class="required mr-1"> المديونية </span>
            </label>
            <!--end::Label-->
            <input id="debt" type="number" class="form-control form-control-solid" placeholder="" name="debt"
                value="{{ $row->debt }}" />
